...
class Village:
    ...
    def generate_map(self):
        ...
        # comment and uncomment the below lines for testing
        wal_l = random.randint(1, 5)
        # wal_l = 4

        for wall in self.walls_top:                                     # wall is 1x1
            wall_obj = bd.Wall(wall, self, wal_l)
        ...
        # cannon random level bw 1 and 5
        for cannon in self.cannons:                                     # cannon is 2x2
            l = random.randint(1, 5)
            cannon_obj = bd.Cannon(cannon, self, l)
        ...
        # wizard tower random level bw 1 and 5
        for wizard_tower in self.wizard_towers:                          # wizard tower is 1X1
            l = random.randint(1, 5)
            wizard_tower_obj = bd.WizardTower(wizard_tower, self, l)
